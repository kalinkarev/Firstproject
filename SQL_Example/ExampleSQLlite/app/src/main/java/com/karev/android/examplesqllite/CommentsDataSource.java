package com.karev.android.examplesqllite;
...
public class CommentsDataSource {
    ...
    public Comment createComment(String comment) {
        ...
        Cursor cursor = database.query(MySQLiteHelper.TABLE_COMMENTS, allComments, MySQLiteHelper.COLUMN_ID + " = " + insertId, null, null,
                null, null);
        cursor.moveToFirst();
